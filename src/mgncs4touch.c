...
BOOL ncs4TouchInitialize(void)
{
    ...
    MGNCS_REGISTER_COMPONENT_EX(mToggle, WS_NONE, WS_EX_NONE, IDC_ARROW, NCS_BGC_3DBODY);
    MGNCS_REGISTER_COMPONENT_EX(mPasswordBox, WS_NONE, WS_EX_NONE, IDC_ARROW, NCS_BGC_3DBODY);
    MGNCS_REGISTER_COMPONENT_EX(mTextView, WS_NONE, WS_EX_NONE, IDC_ARROW, NCS_BGC_3DBODY);
    ...
    MGNCS_INIT_CLASS(mPieceGridItem);
    ...
    MGNCS_INIT_CLASS(mFlowLayout);
    MGNCS_INIT_CLASS(mGridLayout);
    ...
    MGNCS_REGISTER_COMPONENT(mDialPad);
...
void ncs4TouchUninitialize(void)
{
    ...
    MGNCS_UNREG_COMPONENT(mToggle);    
    MGNCS_UNREG_COMPONENT(mPasswordBox);
    MGNCS_UNREG_COMPONENT(mTextView);
    ...
    MGNCS_UNREG_COMPONENT(mDialPad);
